...
(function ($) {
  ...
  $checkbox_container.append('<span>导航栏 边框</span>')
  ...
  $container.append('<h6>暗黑 侧边栏 风格</h6>')
  ...
  $container.append('<h6>明亮 侧边栏 风格</h6>')
  var $sidebar_variants = $('<div />', {
    'class': 'd-flex'
  })
  $container.append($sidebar_variants)
  ...
  $container.append('<h6>系统 标志 风格</h6>')
